...
class TestCompare(unittest.TestCase):
	...
	the signogram and reconstruction in matlab is generated by 
		image = im2double(rgb2gray(imread('phantom.png')));
		theta = linspace(0, 180, max(size(image)));
		sinogram = radon(image, theta);
		save('phantom-sinogram.mat', 'sinogram');
		fbp = iradon(sinogram, theta);
		save('phantom-fbp.mat', 'fbp');
